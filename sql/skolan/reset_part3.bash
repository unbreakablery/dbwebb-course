...
loadSqlIntoSkolan "user" "pass" "dml_update_lonerevision.sql" "Alter table larare"
loadSqlIntoSkolan "user" "pass" "dml_insert_csv.sql" "Alter table larare"
loadSqlIntoSkolan "user" "pass" "dml_join2.sql" "Alter table larare"
