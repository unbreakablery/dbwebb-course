...
#
# cb5651a9bda6835ff09ff6e1ec9d79fd
# webapp
# jq
# v1
# beha20
...
# v4.0.0 (2019-03-05)
#
# Generated 2021-04-05 18:36:06 by dbwebb lab-utility v4.0.0 (2019-03-05).
...
ANSWER=$(jq '.data [0].comments.data [].text' tag-dbwebb.json)
...
ANSWER=$(jq '.data [] | select (.likes.count > 5 and .comments.count >= 1) .link' tag-dbwebb.json)
