...
var about = (function () {
    var showAbout = function () {
        ...
        var about_p1 = document.createElement("p");
        about_p1.textContent = "Hi, My name is Benaris Hajduk and I am 33 years old. " +
        ...
        var about_p2 = document.createElement("p");
        about_p2.textContent = "We moved to Sweden in August 2016, " + 
        ...
        var about_p3 = document.createElement("p");
        about_p3.textContent = "As a person, I am very open and ready to accept any " + 
        ...
        var about_p4 = document.createElement("p");
        about_p4.textContent = "Has the ability to communicate with people at all levels " +
        ...
        var about_p5 = document.createElement("p");
        about_p5.textContent = "My hobbies, maybe can say that I am a real wine lover, " +
        ...
        window.mainContainer.appendChild(about_p1);
        window.mainContainer.appendChild(about_p2);
        window.mainContainer.appendChild(about_p3);
        window.mainContainer.appendChild(about_p4);
        window.mainContainer.appendChild(about_p5);
